...
#inputs{
  ...
  <input style="width:100%" id="inputs" type="text" name="idequipoperteneciente" size="25" value='<?php echo $row['modeloequipo'];?>'/>
  </td>
  <td colspan="3" width="50%" >
  ...
  <tr>
  <td id="tit" colspan="3" width="33.3%"><strong>Tipo de repuesto</strong></td>
  ...
  <tr>
  <td id="tit" colspan="3" width="50%"><strong>Almacenamiento</strong></td>
  <td id="tit" colspan="3" width="50%"><strong>Numero de Serie</strong></td>
  </tr>
  <tr>
  <td colspan="3" >
