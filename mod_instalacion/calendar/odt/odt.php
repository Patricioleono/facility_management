...
<table width="90%" border='1'>
  ...
  <tr>
    ...
    <td colspan="2" width="35%"><input  type="text" name="equipo" value="<?php echo utf8_encode($row['equipo']);?>" style="display: none"> <?php echo utf8_encode($row['equipo']);?></td>
  ...
  <tr>
    ...
    <td width="50%" colspan="2"><b>FECHA DE EMISION</b></td>
  </tr>
  <tr>
    ...
    <td width="55%" colspan="2"><?php echo $fecha_actual;?></td>
