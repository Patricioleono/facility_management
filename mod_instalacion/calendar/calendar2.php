...
<form method="POST" action="../elemento2.php">
        ...
        <input type="button" class="button2" style="BORDER: rgb(128,128,128) 1px none; FONT-SIZE: 10pt; FONT-FAMILY: Verdana;" value="Ficha Equipo" name="Regresar" onclick="location.href='../../fichas/ficha_equipos_instalaciones.php?id=<?php echo $row3['idequipo'] ;?>'" />
</form>
</div>
