...
$i = 0;
$directorio = "equipos_por_piso/primer_piso";
...
if($prueba=='CL'){
$query1="SELECT * FROM instalaciones WHERE piso='1'and idunica='$nombre_fichero'";
...
$query1="SELECT * FROM equipos WHERE piso='1'and idunica='$nombre_fichero'";
$resultado1=$mysqli->query($query1);
$row1=$resultado1->fetch_assoc();
...
$query1="SELECT * FROM servbas WHERE piso='1' AND idunica='$nombre_fichero'";
$resultado1=$mysqli->query($query1);
$row1=$resultado1->fetch_assoc();
$array[$i][0]=utf8_encode($row1['nombreequipo']);
$array[$i][1]=utf8_encode($row1['estadoequipo']);
