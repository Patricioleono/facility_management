    ...
    <?php }?>
        ...
        <script>
                ...
                function listaEquipos() {
                    ...
                    $.ajax({
                        url: 'testajaxpiso2.php', //the script to call to get data          
