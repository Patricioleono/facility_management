<html>
    ...
    <body>
        <div id="info">
            ...
            <button id="bpc" onclick="transparent(bpc)">BPC</button>
            <button id="cl" onclick="transparent(cl)">CL</button>
            <button id="vigas" onclick="transparent(vigas2pp); transparent(vigas3pp); transparent(vigas4pp);transparent(vigas1p);transparent(vigas2p);transparent(vigas3p);transparent(vigas4p);transparent(vigas5p);">Vigas</button>
            <button id="pilares" onclick="transparent(pilares)">Pilares</button>
            <button id="fund" onclick="transparent(fund)">Fundaciones</button>
            <button id="p3_tabiques" onclick="transparent(p3_tabiques)">Tabiques</button>
        </div>
        <div id="pisos">
