...
<div id="filtro">
    <div class="dropdown">
      ...
      <div class="dropdown-content">
        <a href="filtros/equipo_medico/Edificio.php">EQUIPOS MEDICOS</a>
        <a href="filtros/gases_clinicos/Edificio.php">GASES CLINICOS</a>
        <a href="filtros/clima/Edificio.php">CLIMA</a>
        <a href="filtros/ascensor/Edificio.php">ASCENSORES</a>
        <a href="filtros/electricidad/Edificio.php">ELECTRICIDAD</a>
        <a href="filtros/iluminacion/Edificio.php">ILUMINACION</a>
        <a href="filtros/incendio/Edificio.php">INCENDIO</a>
        <a href="#">CORREO NEUMATICO</a>
        <a href="filtros/corrientes_debiles/Edificio.php">CORRIENTES DEBILES</a>
        <a href="filtros/agua_potable/Edificio.php">AGUA POTABLE</a>
        <a href="filtros/alcantarillado/Edificio.php">ALCANTARILLADO</a>
        <a href="filtros/artefacto/Edificio.php">ARTEFACTOS</a>
        ...
        <script>
                ...
                function addGeometry() {
                    ...
                    loader.load('edificiostl/MUROS CUARTO PISO.stl', function (geometry) {
                        piso4 = new THREE.MeshLambertMaterial({color: 0xCCCCCC, transparent: true, opacity: 1});
                        piso4.opacity = 0.2;

                        var mesh = new THREE.Mesh(geometry, piso4);
                        mesh.renderOrder = 0;
                 ...
                 loader.load('edificiostl/LOSAS CUARTO PISO.stl', function (geometry) {
                        piso1 = new THREE.MeshLambertMaterial({color: 0xFFFFCC, transparent: true, opacity: 1});
                        piso1.opacity =0.2;
                ...
                function listaEquipos() {
                    ...
                    $.ajax({
                        url: 'testajaxpiso4.php', //the script to call to get data          
...
var vecCamera = new THREE.Vector2();
 ...
 var subidd=id.substr(0,2);
        if(subidd=='CL'){
                statsNode.innerHTML = "<a href='http://www.bim.cl/hospital_LuisCalvoMackena/fichas/ficha_equipos_instalaciones.php?id=" + buscado.name + "' target='_blank'>Ficha Equipo ID: " + buscado.name + "</a><br><br>Nombre: " + buscado.userData.equipo + "<br><br>Estado: " + buscado.userData.estadoequipo + "<br><br>Tipo: " + buscado.userData.nombreinstalacion + "<br><br>Fabricante: " + buscado.userData.nombrefabricante + "<br><br>Modelo: " + buscado.userData.modelo + "<br><br>Proveedor: " + buscado.userData.nombreproveedor + "<br><br>Sector: " + buscado.userData.recinto + "<br><br>Instalacion: " + buscado.userData.fechainstalacion + "<br><br>Caducidad: " + buscado.userData.fechacaducidadgarantia + "<br><br>Categoria: " + buscado.userData.acreditacion + "<br><br><IMG SRC=../mod_instalacion/" + buscado.userData.imagen + " height='180px' id='imagen1' width='180px' border='1.5px'><br><br>";
        } else if(subidd=='EM'){
                statsNode.innerHTML = "<a href='http://www.bim.cl/hospital_LuisCalvoMackena/fichas/ficha_equipos_medicos.php?id=" + buscado.name + "' target='_blank'>Ficha Equipo ID: " + buscado.name + "</a><br><br>Nombre: " + buscado.userData.nombreequipo + "<br><br>Estado: " + buscado.userData.estadoequipo + "<br><br>Tipo: " + buscado.userData.tipoequipo + "<br><br>Fabricante: " + buscado.userData.nombrefabricante + "<br><br>Modelo: " + buscado.userData.numeromodelo + "<br><br>Proveedor: " + buscado.userData.nombreproveedor + "<br><br>Sector: " + buscado.userData.recinto + "<br><br>Instalacion: " + buscado.userData.fechainstalacion + "<br><br>Caducidad: " + buscado.userData.fechacaducidadgarantia + "<br><br>Categoria: " + buscado.userData.acreditacion + "<br><br><IMG SRC=../mod_inventario/" + buscado.userData.imagen + " height='180px' id='imagen1' width='180px' border='1.5px'><br><br>";
        }else if(subidd=='AS'){
                        statsNode.innerHTML = "<a href='http://www.bim.cl/hospital_LuisCalvoMackena/fichas/ficha_equipos_instalaciones.php?id=" + buscado.name + "' target='_blank'>Ficha Equipo ID: " +buscado.name + "</a><br><br>Nombre: " + buscado.userData.equipo + "<br><br>Estado: " + buscado.userData.estadoequipo + "<br><br>Tipo: " + buscado.userData.nombreinstalacion + "<br><br>Fabricante: " + buscado.userData.nombrefabricante + "<br><br>Modelo: " + buscado.userData.modelo + "<br><br>Proveedor: " + buscado.userData.nombreproveedor + "<br><br>Sector: " + buscado.userData.recinto + "<br><br>Instalacion: " + buscado.userData.fechainstalacion + "<br><br>Caducidad: " + buscado.userData.fechacaducidadgarantia + "<br><br>Categoria: " + buscado.userData.acreditacion + "<br><br><IMG SRC=../mod_instalacion/" + buscado.userData.imagen + " height='180px' id='imagen1' width='180px' border='1.5px'><br><br>";
                            }else if(subidd=='AR'){
                            statsNode.innerHTML = "<a href='http://www.bim.cl/hospital_LuisCalvoMackena/fichas/ficha_artefactos.php?id=" + buscado.name + "' target='_blank'>Ficha Equipo ID: " + buscado.name + "</a><br><br>Nombre: " + buscado.userData.nombreequipo + "<br><br>Estado: " + buscado.userData.estadoequipo + "<br><br>Tipo: " + buscado.userData.tipoequipo + "<br><br>Fabricante: " + buscado.userData.nombrefabricante + "<br><br>Modelo: " + buscado.userData.numeromodelo + "<br><br>Proveedor: " + buscado.userData.nombreproveedor + "<br><br>Sector: " + buscado.userData.recinto + "<br><br>Instalacion: " + buscado.userData.fechainstalacion + "<br><br>Caducidad: " + buscado.userData.fechacaducidadgarantia + "<br><br>Categoria: " + buscado.userData.acreditacion + "<br><br><IMG SRC=../mod_servbas/" + buscado.userData.imagen + " height='180px' id='imagen1' width='180px' border='1.5px'><br><br>";
                            }
