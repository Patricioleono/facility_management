    ...
    <?php }?>
        ...
        <script>
                ...
                function listaEquipos() {
                    ...
                    $.ajax({
                        url: 'testajaxpiso3.php', //the script to call to get data          
