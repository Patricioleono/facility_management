...
<div id="filtro">
    <div class="dropdown">
      ...
      <div class="dropdown-content">
        ...
        <a href="../iluminacion/Edificio.php">ILUMINACIÒN</a>
        ...
        <a href="Edificio.php">ALCANTARILLADO</a>
        ...
        <script>
                ...
                function addGeometry() {
                 ...
                 loader.load('../../edificiostl/LOSAS CUARTO PISO.stl', function (geometry) {
                        ...
                        mesh.scale.set(0.2, 0.2, 0.2);
                        mesh.castShadow = true;
                        mesh.name = "LOSA PISO4";
                        scene.add(mesh);

                    });
                 loader.load('../../edificiostl/LOSAS QUINTO PISO.stl', function (geometry) {
                        losasp5 = new THREE.MeshLambertMaterial({color: 0xCCCCCC, transparent: true, opacity: 1});
                        losasp5.opacity = 0.2;
                        var mesh = new THREE.Mesh(geometry, losasp5);
                        mesh.renderOrder = 0;
                        mesh.doubleSided = true;
                        mesh.frustumCulled = false;
                        mesh.position.set(0, 0, 0);
