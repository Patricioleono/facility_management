...
<a>ALCANTARILLADO</a>
    ...
    <?php }?>
        ...
        <script>
                ...
                var murosp1,losasp1,alcgral,estanque;
                ...
                function addGeometry() {
                  ...
                  loader.load('../../edificiostl/MUROS PRIMER PISO.stl', function (geometry) {
                    ...
                    loader.load('../../edificiostl/LOSAS PRIMER PISO.stl', function (geometry) {
                        losasp1 = new THREE.MeshLambertMaterial({color: 0xCCCCCC, transparent: true, opacity: 1});
                        losasp1.opacity = 0.2;
                        var mesh = new THREE.Mesh(geometry, losasp1);
                        mesh.renderOrder = 0;
                        mesh.doubleSided = true;
                        mesh.frustumCulled = false;
                        mesh.position.set(0, 0, 0);
