...
statsNode1.style.display = 'block';
    var subidd=id.substr(0,2);
                        ...
                        statsNode.innerHTML = "<a href='http://www.bim.cl/BIM/hospital_calvo_mackenna/fichas/ficha_equipos_instalaciones.php?id=" + buscado.name + "' target='_blank'>Ficha Equipo ID: " + buscado.name + "</a><br><br>Nombre: " + buscado.userData.equipo + "<br><br>Estado: " + buscado.userData.estadoequipo + "<br><br>Tipo: " + buscado.userData.nombreinstalacion + "<br><br>Fabricante: " + buscado.userData.nombrefabricante + "<br><br>Modelo: " + buscado.userData.modelo + "<br><br>Proveedor: " + buscado.userData.nombreproveedor + "<br><br>Sector: " + buscado.userData.recinto + "<br><br>Instalacion: " + buscado.userData.fechainstalacion + "<br><br>Caducidad: " + buscado.userData.fechacaducidadgarantia + "<br><br>Categoria: " + buscado.userData.acreditacion + "<br><br><IMG SRC=../../../mod_instalacion/" + buscado.userData.imagen + " height='180px' id='imagen1' width='180px' border='1.5px'><br><br>";
                            ...
                            statsNode.innerHTML = "<a href='http://www.bim.cl/BIM/hospital_calvo_mackenna/fichas/ficha_equipos_medicos.php?id=" + buscado.name + "' target='_blank'>Ficha Equipo ID: " + buscado.name + "</a><br><br>Nombre: " + buscado.userData.nombreequipo + "<br><br>Estado: " + buscado.userData.estadoequipo + "<br><br>Tipo: " + buscado.userData.tipoequipo + "<br><br>Fabricante: " + buscado.userData.nombrefabricante + "<br><br>Modelo: " + buscado.userData.numeromodelo + "<br><br>Proveedor: " + buscado.userData.nombreproveedor + "<br><br>Sector: " + buscado.userData.recinto + "<br><br>Instalacion: " + buscado.userData.fechainstalacion + "<br><br>Caducidad: " + buscado.userData.fechacaducidadgarantia + "<br><br>Categoria: " + buscado.userData.acreditacion + "<br><br><IMG SRC=../../../mod_inventario/" + buscado.userData.imagen + " height='180px' id='imagen1' width='180px' border='1.5px'><br><br>";
                            }else if(subidd=='AS'){
                        statsNode.innerHTML = "<a href='http://www.bim.cl/BIM/hospital_calvo_mackenna/fichas/ficha_equipos_instalaciones.php?id=" + buscado.name + "' target='_blank'>Ficha Equipo ID: " + buscado.name + "</a><br><br>Nombre: " + buscado.userData.equipo + "<br><br>Estado: " + buscado.userData.estadoequipo + "<br><br>Tipo: " + buscado.userData.nombreinstalacion + "<br><br>Fabricante: " + buscado.userData.nombrefabricante + "<br><br>Modelo: " + buscado.userData.modelo + "<br><br>Proveedor: " + buscado.userData.nombreproveedor + "<br><br>Sector: " + buscado.userData.recinto + "<br><br>Instalacion: " + buscado.userData.fechainstalacion + "<br><br>Caducidad: " + buscado.userData.fechacaducidadgarantia + "<br><br>Categoria: " + buscado.userData.acreditacion + "<br><br><IMG SRC=../../../mod_instalacion/" + buscado.userData.imagen + " height='180px' id='imagen1' width='180px' border='1.5px'><br><br>";
                            }else if(subidd=='AR'){
                            statsNode.innerHTML = "<a href='http://www.bim.cl/BIM/hospital_calvo_mackenna/fichas/ficha_artefactos.php?id=" + buscado.name + "' target='_blank'>Ficha Equipo ID: " + buscado.name + "</a><br><br>Nombre: " + buscado.userData.nombreequipo + "<br><br>Estado: " + buscado.userData.estadoequipo + "<br><br>Tipo: " + buscado.userData.tipoequipo + "<br><br>Fabricante: " + buscado.userData.nombrefabricante + "<br><br>Modelo: " + buscado.userData.numeromodelo + "<br><br>Proveedor: " + buscado.userData.nombreproveedor + "<br><br>Sector: " + buscado.userData.recinto + "<br><br>Instalacion: " + buscado.userData.fechainstalacion + "<br><br>Caducidad: " + buscado.userData.fechacaducidadgarantia + "<br><br>Categoria: " + buscado.userData.acreditacion + "<br><br><IMG SRC=../../../mod_servbas/" + buscado.userData.imagen + " height='180px' id='imagen1' width='180px' border='1.5px'><br><br>";
                            }
