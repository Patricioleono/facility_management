...
<div id="filtro">
    <div class="dropdown">
      ...
      <div class="dropdown-content">
        ...
        <a href="../iluminacion/Edificio.php">ILUMINACIﾃ誰</a>
        <a href="../incendio/Edificio.php">INCENDIO</a>
        <a href="#">CORREO NEUMATICO</a>
        <a href="../corrientes_debiles/Edificio.php">CORRIENTES DEBILES</a>
        <a href="../agua_potable/Edificio.php">AGUA POTABLE</a>
        <a href="../alcantarillado/Edificio.php">ALCANTARILLADO</a>
        <a href="Edificio.php">ARTEFACTOS</a>
	...
	<?php }?>
        ...
        <script>
                ...
                function addGeometry() {
                    ...
                    loader.load('../../edificiostl/CLIMA.stl', function (geometry) {
                    ...
                    loader.load('../../edificiostl/LOSAS CUARTO PISO.stl', function (geometry) {
                        losap4 = new THREE.MeshLambertMaterial({color: 0xFFFFCC, transparent: true, opacity: 1});
                        losap4.opacity =0.2;
                    ...
                    loader.load('../../edificiostl/LOSAS QUINTO PISO.stl', function (geometry) {
                        losap5 = new THREE.MeshLambertMaterial({color: 0xCCCCCC, transparent: true, opacity: 1});
                        losap5.opacity = 0.2;
                        var mesh = new THREE.Mesh(geometry, losap5);
                        mesh.renderOrder = 0;
                        mesh.doubleSided = true;
                        mesh.frustumCulled = false;
                        mesh.position.set(0, 0, 0);
                    ...
                    loader.load('../../edificiostl/LOSAS TERCER PISO.stl', function (geometry) {
                        losap3 = new THREE.MeshLambertMaterial({color: 0xCCCCCC, transparent: true, opacity: 1});
                        losap3.opacity = 0.2;

                        var mesh = new THREE.Mesh(geometry, losap3);
                        mesh.renderOrder = 0;
                        mesh.doubleSided = true;
                        mesh.frustumCulled = false;
                        mesh.position.set(0, 0, 0);
 ...
 function equipos(stl, data)
                {
                    ...
                    loader.load(direccion, function (geometry) {
                       if (data[1] == "BUENO")
                        {
                            stlequipos1 = new THREE.MeshLambertMaterial({color: 0x009900, transparent: true, opacity: 1});
                            stlequipos1.opacity = 1;
                        } else if (data[1] == "SIN MANTENCION")
                        {
                            stlequipos1 = new THREE.MeshLambertMaterial({color: 0xFF6600, transparent: true, opacity: 1});
                            stlequipos1.opacity = 1;
                        } else if (data[1] == "FALLANDO")
                        {
                            stlequipos1 = new THREE.MeshLambertMaterial({color: 0xFF9900, transparent: true, opacity: 1});
                            stlequipos.opacity = 1;
                        } else if (data[1] == "EN MANTENCION")
                        {
                            stlequipos1 = new THREE.MeshLambertMaterial({color: 0x9933CC, transparent: true, opacity: 1});
                            stlequipos1.opacity = 1;
                        }
                        var mesh = new THREE.Mesh(geometry, stlequipos1);
                         mesh.frustumCulled = false;
                        mesh.position.set(0, y, 0);
                        mesh.scale.set(0.2, 0.2, 0.2);
                  ...
                  loader.load(direccion, function (geometry) {
                        ...
                        {
                            stlequipos2 = new THREE.MeshLambertMaterial({color: 0xFF6600, transparent: true, opacity: 1});
                            stlequipos2.opacity = 1;
                        } else if (data[1] == "FALLANDO")
                        {
...
console.log(parametros);
                ...
                function init() {
                    ...
                    camera.position.set(-11000, 22000, 3500);
                    camera.up.set(0, 0, 1);
...
//statsNode.innerHTML = "X: "+intercepcion2[0].point.x+" Y: "+intercepcion2[0].point.y+"Z: "+intercepcion2[0].point.z;
                        ...
                        new TWEEN.Tween(controls.target).to({
                            ...
                            y: intercepcion2[0].point.y, z: altura + 300},
                                1000).easing(TWEEN.Easing.Linear.None).onComplete(function () {
                            controls.enabled = true;
                        }).start();
...
statsNode1.style.display = 'block';
    var subidd=id.substr(0,2);
                        if(subidd=='CL'){
                        statsNode.innerHTML = "<a href='http://www.bim.cl/BIM/QA/fichas/ficha_equipos_instalaciones.php?id=" + buscado.name + "' target='_blank'>Ficha Equipo ID: " + buscado.name + "</a><br><br>Nombre: " + buscado.userData.equipo + "<br><br>Estado: " + buscado.userData.estadoequipo + "<br><br>Tipo: " + buscado.userData.nombreinstalacion + "<br><br>Fabricante: " + buscado.userData.nombrefabricante + "<br><br>Modelo: " + buscado.userData.modelo + "<br><br>Proveedor: " + buscado.userData.nombreproveedor + "<br><br>Sector: " + buscado.userData.recinto + "<br><br>Instalacion: " + buscado.userData.fechainstalacion + "<br><br>Caducidad: " + buscado.userData.fechacaducidadgarantia + "<br><br>Categoria: " + buscado.userData.acreditacion + "<br><br><IMG SRC=../../../mod_instalacion/" + buscado.userData.imagen + " height='180px' id='imagen1' width='180px' border='1.5px'><br><br>";

                            } else if(subidd=='EM'){
                            statsNode.innerHTML = "<a href='http://www.bim.cl/BIM/QA/fichas/ficha_equipos_medicos.php?id=" + buscado.name + "' target='_blank'>Ficha Equipo ID: " + buscado.name + "</a><br><br>Nombre: " + buscado.userData.nombreequipo + "<br><br>Estado: " + buscado.userData.estadoequipo + "<br><br>Tipo: " + buscado.userData.tipoequipo + "<br><br>Fabricante: " + buscado.userData.nombrefabricante + "<br><br>Modelo: " + buscado.userData.numeromodelo + "<br><br>Proveedor: " + buscado.userData.nombreproveedor + "<br><br>Sector: " + buscado.userData.recinto + "<br><br>Instalacion: " + buscado.userData.fechainstalacion + "<br><br>Caducidad: " + buscado.userData.fechacaducidadgarantia + "<br><br>Categoria: " + buscado.userData.acreditacion + "<br><br><IMG SRC=../../../mod_inventario/" + buscado.userData.imagen + " height='180px' id='imagen1' width='180px' border='1.5px'><br><br>";
                            }else if(subidd=='AS'){
                        statsNode.innerHTML = "<a href='http://www.bim.cl/BIM/QA/fichas/ficha_equipos_instalaciones.php?id=" + buscado.name + "' target='_blank'>Ficha Equipo ID: " + buscado.name + "</a><br><br>Nombre: " + buscado.userData.equipo + "<br><br>Estado: " + buscado.userData.estadoequipo + "<br><br>Tipo: " + buscado.userData.nombreinstalacion + "<br><br>Fabricante: " + buscado.userData.nombrefabricante + "<br><br>Modelo: " + buscado.userData.modelo + "<br><br>Proveedor: " + buscado.userData.nombreproveedor + "<br><br>Sector: " + buscado.userData.recinto + "<br><br>Instalacion: " + buscado.userData.fechainstalacion + "<br><br>Caducidad: " + buscado.userData.fechacaducidadgarantia + "<br><br>Categoria: " + buscado.userData.acreditacion + "<br><br><IMG SRC=../../../mod_instalacion/" + buscado.userData.imagen + " height='180px' id='imagen1' width='180px' border='1.5px'><br><br>";
                            }else if(subidd=='AR'){
                            statsNode.innerHTML = "<a href='http://www.bim.cl/BIM/QA/fichas/ficha_artefactos.php?id=" + buscado.name + "' target='_blank'>Ficha Equipo ID: " + buscado.name + "</a><br><br>Nombre: " + buscado.userData.nombreequipo + "<br><br>Estado: " + buscado.userData.estadoequipo + "<br><br>Tipo: " + buscado.userData.tipoequipo + "<br><br>Fabricante: " + buscado.userData.nombrefabricante + "<br><br>Modelo: " + buscado.userData.numeromodelo + "<br><br>Proveedor: " + buscado.userData.nombreproveedor + "<br><br>Sector: " + buscado.userData.recinto + "<br><br>Instalacion: " + buscado.userData.fechainstalacion + "<br><br>Caducidad: " + buscado.userData.fechacaducidadgarantia + "<br><br>Categoria: " + buscado.userData.acreditacion + "<br><br><IMG SRC=../../../mod_servbas/" + buscado.userData.imagen + " height='180px' id='imagen1' width='180px' border='1.5px'><br><br>";
                            }
