...
$query="SELECT * FROM eventcalender where checkbox='0' and eventDate != 'NULL' ORDER BY eventDate";
		...
		<center><h1>Mantenimientos Pendientes</h1></center>
			...
			<th><?php echo $fecha ?></th>
				...
				<?php 
					...
					$query2="SELECT * FROM equipos where idunica='$idequipocheck'";
				...
				<tr>
					...
					<td width="20%" colspan="2" id="inputs"><center><?php echo $row2['nombreequipo'] ?></center></td>
				    <td width="20%" colspan="2" id="inputs"><center><?php echo $row2['numeromodelo'] ?></td>
				    <?php if($fecha>$fecha_evento){  
				    	$query11="UPDATE equipos set estadoequipo='SIN MANTENCION' where idunica='$idequipocheck'";
				    	$resultado11=$mysqli->query($query11);?>
				    <td widh="20%" colspan="2" id="inputs" style="color:#FF0000"><center><?php echo $row['eventDate'] ?></center></td>
				    <?php }if($fecha==$fecha_evento) { ?>
				     ...
				     <?php }?>
					<td width="20%" colspan="2" id="inputs"><center><a href="../mod_inventario/calendar/calendar.php?id=<?php echo $row2['id'] ?>">Ir</a></center></td>
				<?php $i ++;} ?>
				</tr>
				<tr>
				<td align="center">
			...
			<td align="center" colspan="2">
       		 <form target="_blank" method="POST" action="../mod_inventario/pdfnotificaciones.php">
