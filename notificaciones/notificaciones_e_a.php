...
$query="SELECT * FROM eventcalenderelementoarquitectonico where checkbox='0' and eventDate != 'NULL'";
		...
		<center><h1>Mantenimientos Pendientes</h1></center>
			...
			<th><?php echo $fecha ?></th>
				...
				<?php 
					...
					$query2="SELECT * FROM elemento_arquitectonico where idunica='$idequipocheck'";
				...
				<tr>
				    ...
				    <td width="20%" colspan="2" id="inputs" style="color:#088A08"><center><?php echo $row['eventDate'] ?></center></td>
				    <?php }else if($fecha==$fecha_evento) { ?>
				     <td width="20%" colspan="2" id="inputs" style="color:#FE9A2E"><center><strong><?php echo $row['eventDate'] ?></strong></center></td>
				     <?php }else if($fecha<$fecha_evento){  ?>
				     <td width="20%" colspan="2" id="inputs" style="color:#0101DF"><center><?php echo $row['eventDate'] ?></center></td>
				     <?php }?>
					<td width="20%" colspan="2" id="inputs"><center><a href="../mod_e_arquitectonico/calendar/calendar.php?id=<?php echo $row2['id'] ?>">Ir</a></center></td>
				<?php } ?>
				</tr>
				<tr>
				<td align="center">
			...
			<td align="center" colspan="2">
       		 <form target="_blank" method="POST" action="../mod_e_arquitectonico/pdfnotificaciones.php">
