...
$query="SELECT * FROM eventcalender2 where checkbox='0' and eventDate != 'NULL' ORDER BY eventDate";
		...
		<center><h1>Mantenimientos Pendientes</h1></center>
			...
			<th><?php echo $fecha ?></th>
				...
				<?php 
					...
					$query2="SELECT * FROM servbas where idunica='$idequipocheck'";
				...
				<tr>
				    ...
				    <?php if($fecha>$fecha_evento){
				    	$query11="UPDATE servbas set estadoequipo='SIN MANTENCION' where idunica='$idequipocheck'";
			...
			<td align="center" colspan="2">
       		 <form target="_blank" method="POST" action="../mod_servbas/pdfnotificaciones.php">
