...
//espacio en blanco
      ...
      $numero=0;
      $consulta = "select * from eventcalenderestructura where eventDate = '".$todaysDate."' and idequipo='".$ids."' and checkbox= '".$numero."'";
      ...
      //identifica dias con evento
        $sqlCount = "select * from eventcalenderestructura where eventDate = '".$dateToCompare."' and idequipo='".$ids."'";
