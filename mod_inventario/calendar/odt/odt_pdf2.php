<?php  
	...
	$ext=".pdf";
		$query1234="UPDATE equipos SET estadoequipo='EN MANTENCION' WHERE idunica='$idelemento'";
	...
	$query1="SELECT * FROM archivos_equipos WHERE nombre='$valor2'";
	...
	$modelo=$row['numeromodelo'];
	$serie=$row['numeroserie'];
	$marca=$row['nombrefabricante'];

	$ubicacion="Piso:".utf8_decode($row['piso'])."-Recinto:".utf8_encode($row['recinto']);
