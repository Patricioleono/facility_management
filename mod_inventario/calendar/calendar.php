...
<body>
  ...
  <?php
    $idsss="SELECT idequipo FROM eventcalender WHERE idequipo='$hola'";
...
//espacio en blanco
      ...
      $numero=0;
      $consulta = "select * from eventcalender where eventDate = '".$todaysDate."' and idequipo='".$testfecha."' and checkbox= '".$numero."'";
      ...
      //identifica dias con evento
        $sqlCount = "select * from eventcalender where eventDate = '".$dateToCompare."' and idequipo='".$testfecha."'";
