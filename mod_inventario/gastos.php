...
$query="SELECT * FROM gastos_equipos WHERE id_elemento='$id'";
$resultado=$mysqli->query($query);
$resultado1=$mysqli->query($query);
$query2="SELECT * FROM equipos WHERE idunica='$id'";
...
<html>
    ...
    <body>
    <center><h2>Historial del equipo : <?php echo utf8_encode($row2['nombreequipo']); ?> <br> ID: <?php echo $row2['idunica']; ?> </h2></center>    
...
<table style="width:20%; margin:auto">
       <tr>
       <td id="inputs"><center>Total Gastado: $<?php while($row1=$resultado1->fetch_assoc()){ 
        $var += $row1['gastos'];
        } echo $var;?></center></td></tr><tr>
    <td><input type="button" style="width:100%;" class="button2" value="Ficha del Equipo" name="Ficha del Equipo" onclick="location.href = 'http://www.bim.cl/hospital_LuisCalvoMackena/fichas/ficha_equipos_medicos.php?id=' + <?php echo''.$id.''; ?>"/></td>
</tr>
</table>
<?php if ($tipousuario=='1'){?>
<br>
