...
<body>
  ...
  <?php
    $idsss="SELECT idequipo FROM eventcalender2 WHERE idequipo='$hola'";
  ...
  <div id="divb">
    <div id="tabla1"> 
        <div id="cabtab1" align="center"> 
          Calendario ID ServBas: <?php echo $row3['idequipo']; ?>
        </div> 
        <div id="cuerpotab1"> 
...
//espacio en blanco
      ...
      $numero=0;
      $consulta = "select * from eventcalender2 where eventDate = '".$todaysDate."' and idequipo='".$testfecha."' and checkbox= '".$numero."'";
      ...
      //identifica dias con evento
        $sqlCount = "select * from eventcalender2 where eventDate = '".$dateToCompare."' and idequipo='".$testfecha."'";
