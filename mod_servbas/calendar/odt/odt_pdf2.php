<?php  
	...
	$ext=".pdf";
		...
		$query1234="UPDATE servbas SET estadoequipo='EN MANTENCION' WHERE idunica='$idelemento'";
	...
	$query1="SELECT * FROM archivos_servbas WHERE nombre='$valor2'";
	$resultado1=$con->query($query1);
	$row1=$resultado1->fetch_assoc();
	$comprobacion=$row1['nombre'];
	if($comprobacion == NULL)
		{
		$query2="INSERT INTO archivos_servbas (idelem, nombre, ext, ruta) VALUES ('$idelemento','$valor2','$ext','$dir2')";
	...
	$query="SELECT * FROM servbas WHERE idunica='$idelemento'";
