...
$query="SELECT * FROM archivos_servbas WHERE idelem= 0 ORDER BY id DESC";
...
<body>
<center><h1>Documentos de Artefactos</h1></center>
...
<center><h1>Subir Nuevo Archivo</h1>
   <form name="enviar_archivo_frm" method="post" ENCTYPE="multipart/form-data"  action="subir.php?id=<?= $id; ?>">
