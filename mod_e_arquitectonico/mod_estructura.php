...
<?php 
	...
	$id=$_POST['id'];
	$select1= "SELECT * from elemento_arquitectonico WHERE idunicaelemento='$id'";
	...
	$alto=$_POST['alto'];
	$ancho=$_POST['ancho'];
	$query="UPDATE elemento_arquitectonico SET nombreelemento='$nombreelemento', tipoelemento='$tipoelemento', largo='$largo', alto='$alto', ancho='$ancho'
...
opendir($dir); 
 ...
 if(isset($_POST['Guardar'])){
			...
			$imagena = $nom."/".$valor;
			$query2="UPDATE elemento_arquitectonico SET imagen='$imagena' WHERE idunicaelemento='$nom'";
