...
$id=$_POST['id'];
$consulta = "select * from elemento_arquitectonico where idunicaelemento='".$id."'";
$datos = $mysqli->query($consulta);
$producto = $datos->fetch_assoc();
$componentes1="SELECT * FROM componentes_arquitectonicos where idunicacomponente='$id'";
$componentes=$mysqli->query($componentes1);
$revestimientos1="SELECT * FROM revestimientos_arquitectonicos where idunicarevestimiento='$id'";
