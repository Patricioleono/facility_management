...
<?php 
	...
	$query="INSERT INTO elemento_arquitectonico (nombreelemento, tipoelemento, idunicaelemento, largo, alto, ancho) 
	VALUES ('$nombreelemento','$tipoelemento','$idunicaelemento','$largo','$alto','$ancho')";

	$query1="INSERT INTO eventcalenderelementoarquitectonico(idequipo) VALUES ($idunicaelemento);";
...
opendir($dir); 
 ...
 if(isset($_POST['enviar'])){
			...
			$imagena = $nom."/".$valor;
			$query2="UPDATE elemento_arquitectonico SET imagen='$imagena' WHERE idunicaelemento='$idunicaelemento'";
