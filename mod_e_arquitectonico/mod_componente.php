...
<?php
	...
	$id=$_GET['id'];
	$select1= "SELECT * from componente_arquitectonicos WHERE idunicacomponente='$id'";
	$nombrecomponente=$_POST['nombrecomponente'];
	$query="UPDATE componentes_arquitectonicos SET nombrecomponente='$nombrecomponente' WHERE idunicacomponente='$id'";
