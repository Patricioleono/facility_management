...
<html>
  ...
  <script>
  	document.addEventListener('copy', function(e){
  		e.clipboardData.setData('text/plain','http://www.bim.cl/BIM/hospital_arequipa/test/fichas/ficha_elemento_arquitectonico.php?id='+<?php echo''.$row['idunicaelemento'].''; ?>);
  		e.preventDefault();
  	});
  </script>
            <style>
